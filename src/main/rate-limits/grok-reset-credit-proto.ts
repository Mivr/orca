...
function encodeKey(field: number, wireType: number): Uint8Array {
  return encodeVarint((field << 3) | wireType)
}

function encodeLengthDelimited(field: number, data: Uint8Array): Uint8Array {
...
export function encodeGetRemainingResetsResponse(tokens: GrokRemainingResetToken[]): Uint8Array {
  return concatBytes(
    tokens.map((token) => {
      const fields = [encodeStringField(10, token.tokenId)]
...
function encodeGrpcWebFrame(flags: number, payload: Uint8Array): Uint8Array {
...
export function encodeGrpcWebRequest(payload: Uint8Array): Uint8Array {
  return encodeGrpcWebFrame(0, payload)
}

export function encodeGrpcWebMessage(payload: Uint8Array, trailerStatus = '0'): Uint8Array {
...
export function decodeRemainingResetTokens(payload: Uint8Array): GrokRemainingResetToken[] {
